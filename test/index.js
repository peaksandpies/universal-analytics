...
describe("ua", function () {
	...
	describe("#event", function () {
		...
		it("should re-use the path when daisy-chained to a pageview", function () {
			...
			ua().pageview(path).event(params);

			_enqueue.calledTwice.should.equal(true, "#_enqueue should have been called twice, once for the pageview, once for the pageview");
